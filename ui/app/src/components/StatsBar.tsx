...
export function StatsBar({ stats }: StatsBarProps) {
  return (
    <motion.footer
      className="h-20 bg-white border-t border-slate-200 flex items-center justify-between px-6 fixed bottom-0 left-0 right-0 z-40"
      ...
      <div className="flex items-center gap-6">
        ...
        >
          ...
          <div>
            ...
            <div className="text-xs text-slate-500">Hypothesis</div>
          </div>
        </motion.div>
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <div className="flex items-center gap-3 w-80">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-xs text-slate-500">Launched</span>
          </div>
          ...
          <div className="flex items-center gap-1.5">
            <span className="text-xs text-slate-500">Hypothesis +350</span>
          </div>
        </div>
      </div>
